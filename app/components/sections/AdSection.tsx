...
const AdSection = () => {
  ...
  return (
     <div ref={sectionRef} id="ad-section" className="relative lg:pt-50 pt-16 min-h-screen h-full lg:grid grid-cols-2 max-md:gap-12 lg:px-24 px-6">
      <div ref={leftRef}>
          <div className="flex flex-col lg:gap-4 gap-6 will-change-transform">
