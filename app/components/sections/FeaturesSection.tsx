		...
		<section className='py-3 relative bg-offwhite dark:bg-ink transition-colors duration-500 ease-out'>
			<header className='lg:px-24 px-6'>
				...
				<div className='lg:grid lg:grid-cols-3 flex text-xs font-plus font-semibold py-4'>
					<span>00</span>
					<span>/05</span>
					<div className='w-2.5 h-2.5 bg-ink rounded-full ml-auto'></div>
				</div>
				<h2 className='lg:text-5xl text-2xl lg:leading-normal leading-tight font-black font-plus uppercase max-w-30 lg:mt-20 mt-10'>
				...
				<motion.div
					...
					<div className='lg:py-32 pt-14 pb-20 flex flex-col gap-16 shrink-0 lg:max-w-110 max-w-75'>
						...
						<div className='flex flex-col gap-4'>
							...
							<p className='font-medium'>
								We partnered with Nova Labs to design a next-generation AI
								productivity platform, building scalable systems and intuitive
								interaction models.
							</p>
						</div>
					</div>
					<div className='lg:py-32 py-16 flex flex-col gap-16 shrink-0 lg:max-w-110 max-w-75'>
						...
						<div className='flex flex-col gap-4'>
							...
							<p className='font-medium'>
								A brand transformation for an outdoor goods company redefining
								modern exploration. A new website, mobile app, and identity
								system.
							</p>
						</div>
					</div>
					<div className='lg:py-32 py-16 flex flex-col gap-16 shrink-0 lg:max-w-110 max-w-75'>
						...
						<div className='flex flex-col gap-4'>
							...
							<p className='font-medium'>
								A digital-first editorial experience designed to prioritize
								immersive storytelling. A new thing for a new generation of
								readers. Try it out, it&apos;s free.
							</p>
						</div>
					</div>
					<div className='lg:py-32 py-16 flex flex-col gap-16 shrink-0 lg:max-w-110 max-w-75'>
						...
						<div className='flex flex-col gap-4'>
							...
							<p className='font-medium'>
								Reimagining a telecommunications brand for a frictionless,
								customer-first future. A new experience for a new generation of
								consumers. Good things come to those who wait.
							</p>
						</div>
					</div>
					<div className='lg:py-32 py-16 flex flex-col gap-16 shrink-0 lg:max-w-110 max-w-75'>
						...
						<div className='flex flex-col gap-4'>
							...
							<p className='font-medium'>
								We partnered with Razor AI to design a next-generation AI
								productivity platform, building scalable systems and intuitive
								interaction models. New features for a new generation of users.
							</p>
						</div>
					</div>
				</motion.div>
