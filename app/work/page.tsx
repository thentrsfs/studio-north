			...
			<div
				...
				<div className='flex flex-col gap-20 pr-6 lg:pr-24'>
					...
					<div className='flex max-lg:flex-col lg:flex-row-reverse lg:justify-between lg:items-end gap-20'>
						<p className='font-semibold text-sm max-w-80 text-ink/80 reveal '>
							We create work where clarity meets surprise, helping brands
							connect with culture through shared values and perspectives.
						</p>
							...
							<div
								...
								<div className='grid grid-cols-2 gap-5 max-lg:flex max-lg:overflow-x-auto max-lg:gap-4 max-lg:snap-x max-lg:snap-mandatory max-lg:scroll-smooth no-scrollbar'>
									{item.images.map((image) => (
										<article
											key={image.id}
											className='group flex flex-col cursor-pointer gap-4 snap-start max-md:w-70 md:w-90 lg:w-full max-lg:shrink-0'>
											...
											<div>
												...
												<p className='font-semibold text-xs uppercase max-w-[65%] text-ink/80'>
													{image.description}
												</p>
											</div>
										</article>
